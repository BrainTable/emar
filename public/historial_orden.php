<?php
// filepath: /opt/lampp/htdocs/Proyectos/Emar/public/historial_orden.php
...
$usuarios = [];
$res_usuarios = $mysqli->query("SELECT DISTINCT u.id, u.nombre FROM historial_orden h LEFT JOIN usuarios u ON h.usuario_id = u.id WHERE h.orden_id = $orden_id ORDER BY u.nombre");
...
<head>
    <meta charset="UTF-8">
    <title>Historial de la Orden #<?php echo $orden_id; ?></title>
...
<body>
    <div class="container">
        <h1>Historial de la Orden #<?php echo $orden_id; ?></h1>
        ...
        <table>
            ...
            <tr>
                <td class="no-data" data-label="Sin datos" colspan="4">No hay historial para esta orden.</td>
            </tr>
            <?php endif; ?>
        </table>
        <br>
        <a href="ordenes_servicio_admin.php">Volver a las órdenes</a>
    </div>
</body>
</html>